...
public class CarryTheNametag
{
    ...
    public static class CarryNametagEvent {
        ...
        public static void onBlocksRegistry(BabyEntitySpawnEvent event) {
            StringTextComponent componentcustomName1 = (StringTextComponent) event.getParentA().getCustomName();
            StringTextComponent componentcustomName2 = (StringTextComponent) event.getParentB().getCustomName();
            ...
            if(componentcustomName1 != null && componentcustomName2 != null && event.getChild() != null) {
                ...
                if(customName1.equals(customName2)){
                    ...
                    event.getChild().setCustomName(new StringTextComponent(customName1));
                }else{
                    ...
                    if(event.getChild().getRandom().nextInt(2) == 1) event.getChild().setCustomName(new StringTextComponent(newname1 + newname2));
                    else event.getChild().setCustomName(new StringTextComponent(newname2 + newname1));
                }
            }
